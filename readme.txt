=== File Away ===
Contributors: thomstark, maikunari
...
**Security-patched version:** https://github.com/maikunari/file-away
...
== Changelog ==
= 3.9.9.0.2 =
* Security: Fixed CVE-2025-2512 - Unauthenticated arbitrary file upload vulnerability
* Security: Fixed CVE-2023-0431 - Stored XSS via shortcode attributes
* Security: Added authentication requirement for file management AJAX actions
* Security: Added dangerous file extension blocklist for uploads
* Security: Added capability check (upload_files) for file uploads
= 3.9.9.0.1 =
